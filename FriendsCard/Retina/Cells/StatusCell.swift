            ...
            ZStack(alignment: .leading) {
                ...
                VStack {
                    HStack {
                        ...
                        Text(name).foregroundColor(.rWhite).retinaTypography(.h5_main).fixedSize(horizontal: false, vertical: true).frame(width: 104, alignment: .leading).padding(.leading, 12)
                    }
                }
            }
            ZStack(alignment: .leading) {
